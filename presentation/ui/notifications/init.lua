...
timed_load:require(... .. ".bluetooth")
timed_load:require(... .. ".email")
timed_load:require(... .. ".error")
timed_load:require(... .. ".github")
timed_load:require(... .. ".gitlab")
timed_load:require(... .. ".lock")
timed_load:require(... .. ".network")
timed_load:require(... .. ".picom")
timed_load:require(... .. ".playerctl")
timed_load:require(... .. ".record")
timed_load:require(... .. ".screenshot")
timed_load:require(... .. ".theme")
timed_load:require(... .. ".udev")
timed_load:require(... .. ".upower")